use crate::constants::btc::{
    DIFFICULTY_ADJUSTMENT_INTERVAL_BITCOIN, MAINNET_HEADER_586656, MAINNET_HEADER_705600,
    MAINNET_HEADER_705601, MAINNET_HEADER_705602, TESTNET_HEADER_2132555, TESTNET_HEADER_2132556,
};
