...
fn init() {
    ...
    let mut block_2 = BlockBuilder::new().with_prev_header(*block_1.header);
    ...
    let mut block_5 = BlockBuilder::new().with_prev_header(*block_4.header);
